...
\begin{activities}
    ...
    \aprasymas{
        ...
        \begin{enumerate}
            ...
            \item \textit{S3 Minio}~\cite{minioinc.MinIOS3Compatible} -- duomenų saugykla, palaikanti S3 protokolą. Ši saugykla veikia konteinerizuotoje aplinkoje. Kiekviena sistema gali turėti savo \textit{Minio} komponentą ir ten kaupti duomenis. Tokiu atveju už šį komponentą atsakinga sistemą prižiūrinti komanda.
    ...
    \aprasymas{
        ...
        Vartotojo sąsaja susideda trijų dalių:
        \begin{enumerate}
            \item \textbf{Įrašų paieška}. Čia nurodomas ieškomo įrašo tipas, įrašo identifikatorius ir nurodoma, ar ieškoti archyvuotų įrašo versijų.
            \item \textbf{Įrašų lentelė}. Čia rodomi visi pagal paieškos filtrą rasti įrašai. Jie vaizduojami lentelėje, kurios stulpeliai - dinamiški, jų kiekis priklauso nuo įrašuose esančių meta duomenų \zr{fig:ui}.
            \item \textbf{Įrašų palyginimas}. Lyginami į \textit{JSON} formatą konvertuoti įrašai \zr{fig:ui:diff}.
        \end{enumerate}
        
    }
    \rezultatai{
        Sukurta vartotojo sąsaja, įgyvendinanti susijusius funkcinius reikalavimus.
        % Issue URL: https://github.com/onlyidev/bachelor.practice/issues/6
        \begin{figure}[h]
            \includegraphics[width=0.5\textwidth]{images/ui/1.png}
            \includegraphics[width=0.5\textwidth]{images/ui/2.png}            
            \caption{Vartotojo sąsajos pavyzdys}
            \label{fig:ui}
        \end{figure}

        \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{images/ui/3.png}
            \caption{Įrašų palyginimo vartotojo sąsajos pavyzdys}
            \label{fig:ui:diff}
        \end{figure}
